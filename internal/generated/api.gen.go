...
type ServerInterface interface {
	...
	// (POST /pvz_driver/{pvzId}/close_last_reception)
	...
	// (POST /pvz_driver/{pvzId}/delete_last_product)
...
func (siw *ServerInterfaceWrapper) PostPvzPvzIdCloseLastReception(c *gin.Context) {
	...
	err = runtime.BindStyledParameter("simple", false, "pvzId", c.Param("pvzId"), &pvzId)
	if err != nil {
...
func RegisterHandlersWithOptions(router gin.IRouter, si ServerInterface, options GinServerOptions) {
	...
	router.POST(options.BaseURL+"/product_driver", wrapper.PostProducts)
	router.GET(options.BaseURL+"/pvz_driver", wrapper.GetPvz)
	router.POST(options.BaseURL+"/pvz_driver", wrapper.PostPvz)
	router.POST(options.BaseURL+"/pvz_driver/:pvzId/close_last_reception", wrapper.PostPvzPvzIdCloseLastReception)
	router.POST(options.BaseURL+"/pvz_driver/:pvzId/delete_last_product", wrapper.PostPvzPvzIdDeleteLastProduct)
	router.POST(options.BaseURL+"/reception_driver", wrapper.PostReceptions)
