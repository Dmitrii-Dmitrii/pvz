...
type ServerInterface interface {
	...
	// (POST /pvzs/{pvzId}/close_last_reception)
	...
	// (POST /pvzs/{pvzId}/delete_last_product)
...
func RegisterHandlersWithOptions(router gin.IRouter, si ServerInterface, options GinServerOptions) {
	...
	router.GET(options.BaseURL+"/pvzs", wrapper.GetPvz)
	router.POST(options.BaseURL+"/pvzs", wrapper.PostPvz)
	router.POST(options.BaseURL+"/pvzs/:pvzId/close_last_reception", wrapper.PostPvzPvzIdCloseLastReception)
	router.POST(options.BaseURL+"/pvzs/:pvzId/delete_last_product", wrapper.PostPvzPvzIdDeleteLastProduct)
